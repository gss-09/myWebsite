        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {contacts.map((c) => (
            <a
              ...
              className="group relative flex flex-col items-center text-center gap-2 p-5 rounded-xl
                bg-white/40 dark:bg-black/30 backdrop-blur-sm
            ...
            >
              ...
              <span className="relative z-10 font-semibold text-sm sm:text-base">{c.name}</span>
              <span className="relative z-10 text-xs text-gray-500 dark:text-gray-400 truncate max-w-full">
                {c.handle}
              </span>
            </a>
          ))}
